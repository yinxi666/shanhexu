...
import * as RedPages from './pages.js?v=2026081516';
import * as RedCardGen from './cardgen.js?v=2026081516';
import * as RedLongMarch from './longmarch.js?v=2026081516';
import { initChatWidget } from './chat.js?v=2026081516';
import { initQuiz } from './quiz.js?v=2026081516';
import { initDarkMode } from './darkmode.js?v=2026081516';
import { initMobileNav } from './mobile-nav.js?v=2026081516';
import { initHomepageInnovation } from './homepage.js?v=2026081516';
import { loadVenues } from './venue-store.js?v=2026081516';
import { initActionDelegate } from './action-delegate.js?v=2026081516';
import { initEntranceAnimation } from './entrance-animation.js?v=2026081516';
import { initHeroCarousel } from './hero-carousel.js?v=2026081516';
import { loadLayout } from './layout-loader.js?v=2026081516';
import { getBasePath, isHomePage } from './utils.js?v=2026081516';
import { initFeatureStage } from './feature-stage.js?v=2026081516';
...
async function boot() {
  ...
  // 与 pages.js autoInit 共用 isHomePage 判定，避免双份首页谓词漂移
  if (isHomePage()) {
  ...
  window.__shanhexuBooted = true;

  // Service Worker：离线可用 + 静态资源缓存（不阻塞初始化；浏览器不支持或注册失败则静默）
