...
import { escapeHtml, escapeAttr, sanitizeUrl, getBasePath, resolveAssetPath, safeStorage } from './utils.js?v=2026081006';
...
function generateReply(query) {
  ...
  const knowledge = [
    ...
    { re: /(长征|二万五千里)(?!.*(?:精神|纪念馆|路线|推荐))/, answer: ' <b>长征</b>（1934.10—1936.10）是中国工农红军在第五次反"围剿"失利后进行的战略转移，历经二万五千里，跨越14个省，翻越夹金山、雪山草地，胜利会师甘肃会宁，铸就了伟大的<b>长征精神</b>。' },
