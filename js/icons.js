...
const PATHS = {
  ...
  /* 心形描边：未点赞 */
  'heart-outline': '<path d="M12 20s-7-4.6-7-10a4.2 4.2 0 0 1 7-3.2A4.2 4.2 0 0 1 19 10c0 5.4-7 10-7 10z"/>',
  /* 月亮：深色模式 */
  ...
  /* 勋章：长征纪念卡 */
  medal: '<circle cx="12" cy="9" r="5"/><path d="M9.2 13.2L7.5 21l4.5-2.5L16.5 21l-1.7-7.8"/>',
  /* 笔：留言 */
  ...
  /* 天平：对比 */
  scale: '<path d="M12 4v16M8 20h8"/><path d="M5 7h14"/><path d="M4.5 7l-2 6a2.8 2.8 0 0 0 4 0z"/><path d="M19.5 7l-2 6a2.8 2.8 0 0 0 4 0z"/>',
  /* 对勾：正确 */
